...
$building_id   = northform_block_field( 'hero_building_image' );
...
<section class="nf-hero" id="<?php echo esc_attr( $anchor ); ?>" aria-labelledby="<?php echo esc_attr( $heading_id ); ?>">
	...
	<?php if ( $building_id ) : ?>
		<figure class="nf-hero__building" data-hero-massing aria-hidden="true">
			<?php echo northform_block_image( $building_id, 'full', array( 'alt' => '', 'loading' => 'lazy', 'decoding' => 'async', 'sizes' => '86vw' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		</figure>
	<?php endif; ?>
